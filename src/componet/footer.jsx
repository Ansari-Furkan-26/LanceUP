...
const Footer = () => {
  ...
  const items = [
    ...
    { type: 'section', title: 'Support', items: ['Find Work', 'Learning Center', 'Post Jobs', 'Enterprise solution'] },
  ...
  return (
    <div className=' mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      ...
      <div>
        <h1 className='w-full text-3xl lg:text-4xl xl:text-5xl font-bold text-[#00df9a]'>LanceUP</h1>
        <p className='py-4'>
